        ...
        while True:
            ...
            async for item in cursor:
                ...
                if len(item_list) == page_size:
                    ...
                    sort_query and log_switch and logger.info(f'mongo:{collect.full_name} | getter {fetch_cnt/return_cnt*100:>7.2f}% | fetch {fetch_cnt} | end \'_id\' {type(page_id)}:{str(page_id)}')
                    yield item_list
                    item_list = []
            if item_list:
                yield item_list
